...
export default class LogIn extends OmniElement {
  ...
  doSignIn() {
    ...
    const matchedUser = users.find(
      (user) =>
        (user.user_login_details.username === inputUsername || user.user_login_details.officeEmail === inputPassword) 
      ...
      <omni-style>
        <div class="columns is-centered is-vcentered" style="height:100vh; ">
          <div class="column is-narrow">
            <div
              class="box has-text-centered pd-7"
            >
              <!-- Sign-in form -->
  ...
  rendernav() {
    ...
    if (this.userRole.includes("Admin")) {
      ...
      return html`<user-data1></user-data1>`;
    }
    else {
      return html``;
    }
