...
deleteUser(index) {
  ...
  localStorage.setItem("userData", JSON.stringify(userData)); // Update the local storage
  this.data = this.loadUserData(); // Refresh the data displayed in the table
  this.requestUpdate(); // Request an update to reflect the changes
}
