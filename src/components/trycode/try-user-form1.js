...
////////////////////////////////////////////////
  ...
  handleOfficePhoneNumberChange(e) {
    ...
    } else if (this.dataArray.some((data) => data.officephoneNumber === input)) {
  ...
  handlestatusChange(e) {
    ...
    this.selectedstatusError =
      this.selectedstatus.length === 0 ? "Role is required" : "";
    this.requestUpdate();
  }
  ...
  renderData() {
    ...
    return html`
      ...
      <section class="modal-card-body">
        ...
        <hr />
        <p class="is-size-4 has-text-weight-bold has-text-dark gp-16">
          Contact Details
        </p>
        <div class="columns col-spacing pt-3 ">
          ...
          <div class="column is-one-third">
            ...
            <input
              class="${this.officephoneNumberError ? "input error-border" : "input"}"
              type="tel"
              maxlength="10"
        ...
        <hr />
        <!-- <p class="is-size-3  pt-4 has-text-weight-bold has-text-dark">
          Address Detail :
        </p> -->
        <!-- <p class="is-size-4  pt-4 has-text-weight-bold has-text-dark">
        ...
        <div class="columns col-spacing pr-2">
          <div class="column is-one-third">
        ...
        <div class="columns col-spacing pt-2 pr-2">
          <div class="column is-one-third ">
            <p class="mb-3 ml-3 ">* District</p>
            <omni-dropdown
              part="target "
        ...
        <div class="columns col-spacing">
          ...
          <div class="column is-one-third">
            <p class="mb-2 ml-2">* Confirm Password </p>
            <input
              class="${this.confirmPasswordError ? "input error-border" : "input"}"
              type="password"
            ...
            <div class=" is-flex">
              ${this.confirmPasswordError
                ? html`<omni-icon
                    ...
                    ></omni-icon>
                    <span class="pt-2 pl-1  has-text-grey is-size-6"
                      >${this.confirmPasswordError}</span
                    >`
                : ""}
            </div>
          </div>
        ...
        <div class="columns col-spacing">
        <div class="column is-one-third ">
            <p class="mb-2 ml-3 ">* Office Email ID</p>
            <input
          ...
          <div class="column is-one-third">
            <p class="mb-2 ml-2">* Status</p>
            <omni-dropdown
              class="pd-4"
              placeholder="Account Status"
              typeahead
              error="${this.selectedstatusError ? this.selectedstatusError : ""}"
              searchindropdown
              .options=${this.status}
        ...
        <div
          class="columns is-flex is-align-items-center is-justify-content-space-between  mr-1 "
        >
